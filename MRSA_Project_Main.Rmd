...
**Ryan Campbell**: Ryan set up the GitHub Repository and was the sole contributor to the TDA.R file. He also contributed to most of the section for Topological Data Analysis. Ryan created the barcode and persistance plots in R as part of the Topological Data Analysis. These are referenced in our paper as figure 3.4 (left) and (right).
